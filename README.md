...
A lightweight, web-based Event Management System built using the Flask framework. This application allows users to view upcoming events, register for them, and provides an administrative view to manage event listings.

🚀 Features
Home Page: Simple and welcoming landing page.
...
📋 Prerequisites
Ensure you have Python installed on your system. You will also need pip to install Flask.
...
└── static/             # CSS and Image files (if any)
📝 Future Enhancements
[ ] Connect to a database (MySQL or MongoDB).
